    ...
    <div class="flex">
            <form method="POST" action="/posts/{{$post->id}}/like">
                ...
                <div class="flex items-center mr-4">
                    <button type="submit">
                        <svg viewBox="0 0 20 20" class="{{ $post->isLikedBy(current_user()) ? 'text-blue-500' : 'text-gray-500' }} mr-1 w-6">
            ...
            <form method="POST" action="/posts/{{$post->id}}/dislike">
                ...
                <div class="flex items-center mr-4">
                    <button type="submit">
                        <svg viewBox="0 0 20 20" class="{{ $post->isDislikedBy(current_user()) ? 'text-blue-500' : 'text-grey-500' }} mr-1 w-6">
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g class="fill-current">
        ...
        @endif
        <a class="btn btn-primary" href="{{route('replies.create', $post->id)}}">
