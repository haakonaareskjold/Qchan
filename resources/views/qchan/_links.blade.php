...
<nav class="aninav">
    <ul class="aninav__list">
        ...
        <li class="aninav__listitem {{ \Illuminate\Support\Facades\Request::path() === 'posts' ? 'aninav__listitem-active' : ''}}">
        ...
        <li class="aninav__listitem {{ \Illuminate\Support\Facades\Request::path() === 'explore' ? 'aninav__listitem-active' : ''}}">
        ...
        <li class="aninav__listitem {{ \Illuminate\Support\Facades\Request::path() === 'notifications' ? 'aninav__listitem-active' : ''}}">
        ...
        <li class="aninav__listitem {{ \Illuminate\Support\Facades\Route::getFacadeRoot()->current()->uri() === 'profiles/{user}' ? 'aninav__listitem-active' : ''}}">
